...
public class PMSplitProcessor extends RefactoringProcessor implements
		PMProcessor {
	...
	public PMSplitProcessor(ITextSelection selection,
			...
			if (selectedNode instanceof ExpressionStatement) {
				...
				if (assignmentStatement.getExpression() instanceof Assignment) {
					...
					if (assignmentExpression.getLeftHandSide() instanceof SimpleName) {
						...
						SimpleName name = (SimpleName) assignmentExpression
								.getLeftHandSide();
						...
						if (declaration != null
								&& PMASTNodeUtils
										.variableDeclarationIsLocal(declaration)) {
							_step = new PMSplitStep(project,
