...
public class PMInconsistency {
	...
	public PMInconsistency(PMProject project,
			PMCompilationUnit pmCompilationUnit, ASTNode node) {
		_project = project;
	 ...
	 * 
	 * @return The relevant quick fixes. The default implementation returns
	 *         none.
	 */
