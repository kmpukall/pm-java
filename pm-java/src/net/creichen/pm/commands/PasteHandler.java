...
public class PasteHandler extends AbstractCommandHandler {
    ...
    public final void handleEvent(final ExecutionEvent event) {
        ...
        if (insertionPoint.isValid()
                && (selectedNode instanceof Block && pasteboard.containsOnlyNodesOfClass(Statement.class) || selectedNode instanceof TypeDeclaration
            ...
            final PasteStep pasteStep = new PasteStep(getProject(), selectedNode, childProperty, insertIndex);
