...
public class PMASTNodeUtils {
	public static VariableDeclaration localVariableDeclarationForSimpleName(
			SimpleName name) {
		return (VariableDeclaration) ((CompilationUnit) name.getRoot())
				.findDeclaringNode(name.resolveBinding());
	}

	// We also consider parameters, for statement vars, and catch vars to be
	// local
	public static boolean variableDeclarationIsLocal(
