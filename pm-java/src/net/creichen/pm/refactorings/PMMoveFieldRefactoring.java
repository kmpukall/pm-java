...
public class PMMoveFieldRefactoring {
	...
	public PMMoveFieldRefactoring(PMProject project,
			FieldDeclaration fieldDeclaration, TypeDeclaration newParent) {
		_project = project;
	...
	public void apply() {
		...
		TypeDeclaration newParent = (TypeDeclaration) _newParentReference
				.getNode();

		PMPasteStep pasteStep = new PMPasteStep(_project, newParent,
				TypeDeclaration.BODY_DECLARATIONS_PROPERTY, newParent
