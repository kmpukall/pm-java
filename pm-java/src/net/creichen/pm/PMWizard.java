...
public class PMWizard extends RefactoringWizard {
	...
	public boolean performFinish() {
		...
		if (result) {
			...
			PMProject project = PMWorkspace.sharedWorkspace().projectForIJavaProject(((PMProcessor)getProcessor()).getICompilationUnit().getJavaProject());
		...
		System.out.println("STEP time is " + PMTimer.sharedTimer().accumulatedSecondsForKey("STEP"));
