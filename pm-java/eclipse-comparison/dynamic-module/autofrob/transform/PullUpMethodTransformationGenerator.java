...
public class PullUpMethodTransformationGenerator extends TransformationGenerator<PullUpTransformation>
{
	...
	generateTransformation()
	{
		...
		return new PullUpTransformation(this.tproject, choice.getLeft(), elements, true);
	}
	...
	handleProjectChange()
	{
		mfgenerator = new MFGenerator<AMethod>(this.tproject, AMethodEnumerator.singleton, ASubtypeKindSelector.singleton);
	}
