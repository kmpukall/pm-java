...
public class PMSelectionTest extends PMTest {
	...
	public void testSelectStatement() {
		...
		PMSelection whileSelection = new PMSelection(compilationUnit, 62 - 26,
				89 - 62);
	...
	public void testSelectMemberDeclaration() {
		...
		PMSelection selectionObject = new PMSelection(compilationUnit, 35 - 26,
				43 - 35);
	...
	public void testSelectStatementWithSurroundingWhitespace() {
		...
		PMSelection selectionObject = new PMSelection(compilationUnit, 54 - 26,
				59 - 54);
	...
	public void testSelectSimpleName() {
		...
		PMSelection selectionObject = new PMSelection(compilationUnit, 49 - 26,
				1);
	...
	public void testInsertionIndexAtBeginningOfBlock() {
		...
		PMInsertionPoint insertionPointDescriptor = new PMInsertionPoint(
				compilationUnit, 45 - 26);
	...
	public void testInsertionIndexInBodyDeclarationsListNotDirectlyOnEdge() {
		...
		insertionPointDescriptor = new PMInsertionPoint(compilationUnit,
				44 - 26);
