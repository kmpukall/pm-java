...
public class PMSelectionTest extends PMTest {
    ...
    public void testInsertionIndexAtBeginningOfBlock() {
        ...
        final PMInsertionPoint insertionPointDescriptor = new PMInsertionPoint(compilationUnit,
                45 - 26);
    ...
    public void testNoneSaneSelection() {
        ...
        final PMSelection selectionObject = new PMSelection(compilationUnit, 59 - 26, 61 - 59);
    ...
    public void testSelectMemberDeclarations() {
        ...
        final PMSelection selectionObject = new PMSelection(compilationUnit, 35 - 26, 79 - 35);
    ...
    public void testSelectMethodInvocation() {
        ...
        final PMSelection selectionObject = new PMSelection(compilationUnit, 59 - 26, 4);
    ...
    public void testSelectSimpleName() {
        ...
        final PMSelection selectionObject = new PMSelection(compilationUnit, 49 - 26, 1);
    ...
    public void testSelectStatement() {
        ...
        final PMSelection whileSelection = new PMSelection(compilationUnit, 62 - 26, 89 - 62);
    ...
    public void testSelectStatements() {
        ...
        final PMSelection selectionObject = new PMSelection(compilationUnit, 59 - 26, 69 - 59);
    ...
    public void testSelectStatementWithSurroundingWhitespace() {
        ...
        final PMSelection selectionObject = new PMSelection(compilationUnit, 54 - 26, 59 - 54);
