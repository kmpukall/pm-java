...
public class PMRDefsAnalysisTest extends PMTest {
	...
	public void testStraightlineCodeReachingDefsNoUses() {
		...
		CompilationUnit compilationUnit = parseCompilationUnitFromSource(
				source, "S.java");
	...
	public void testStraightlineCodeUses() {
		...
		Assignment xAssignment = PMASTQuery
				.assignmentInMethodInClassInCompilationUnit(0, "m", 0, "S", 0,
						compilationUnit);

		PMDef xAssignmentDef = (PMDef) thirdXUse.getReachingDefinitions()
				.toArray()[0];
	...
	public void testDefiningInitializer() {
		...
		PMDef xInitializerDef = (PMDef) thirdXUse.getReachingDefinitions()
				.toArray()[0];

		VariableDeclaration xDeclaration = PMASTQuery
				.localWithNameInMethodInClassInCompilationUnit("x", 0, "m", 0,
						"S", 0, compilationUnit);
	...
	public void testUseInInitializer() {
		...
		PMDef defForSecondYUse = (PMDef) secondYUse.getReachingDefinitions()
				.toArray()[0];

		VariableDeclaration yDeclaration = PMASTQuery
				.localWithNameInMethodInClassInCompilationUnit("y", 0, "m", 0,
						"S", 0, compilationUnit);
	...
	public void testDefinitionInPostIncrement() {
		...
		PMDef defForThirdYUse = (PMDef) thirdYUse.getReachingDefinitions()
				.toArray()[0];

		PostfixExpression yPlusPlus = (PostfixExpression) PMASTQuery
				.simpleNameWithIdentifierInMethodInClassInCompilationUnit("y",
						1, "m", 0, "S", 0, compilationUnit).getParent();
	...
	public void testDefinitionsInIfThenElseBody() {
		...
		SimpleName fourthY = PMASTQuery
				.simpleNameWithIdentifierInMethodInClassInCompilationUnit("y",
						3, "m", 0, "S", 0, compilationUnit);
		...
		Assignment yEquals5 = PMASTQuery
				.assignmentInMethodInClassInCompilationUnit(0, "m", 0, "S", 0,
						compilationUnit);
		Assignment yEquals6 = PMASTQuery
				.assignmentInMethodInClassInCompilationUnit(1, "m", 0, "S", 0,
						compilationUnit);
	...
	public void testDefinitionsInIfThenBody() {
		...
		VariableDeclaration yEquals1 = PMASTQuery
				.localWithNameInMethodInClassInCompilationUnit("y", 0, "m", 0,
						"S", 0, compilationUnit);
		Assignment yEquals5 = PMASTQuery
				.assignmentInMethodInClassInCompilationUnit(0, "m", 0, "S", 0,
	...
	public void testDefinitionsInNestedIfThenElse() {
		...
		SimpleName sixthY = PMASTQuery
				.simpleNameWithIdentifierInMethodInClassInCompilationUnit("y",
						5, "m", 0, "S", 0, compilationUnit);
		...
		Assignment yEquals2 = PMASTQuery
				.assignmentInMethodInClassInCompilationUnit(0, "m", 0, "S", 0,
						compilationUnit);
		Assignment yEquals3 = PMASTQuery
				.assignmentInMethodInClassInCompilationUnit(1, "m", 0, "S", 0,
						compilationUnit);
		Assignment yEquals4 = PMASTQuery
				.assignmentInMethodInClassInCompilationUnit(2, "m", 0, "S", 0,
						compilationUnit);
		Assignment yEquals5 = PMASTQuery
				.assignmentInMethodInClassInCompilationUnit(3, "m", 0, "S", 0,
						compilationUnit);
	...
	public void testDefinitionsInWhileLoop() {
		...
		Assignment yEqualsYPlus1 = PMASTQuery
				.assignmentInMethodInClassInCompilationUnit(0, "m", 0, "S", 0,
						compilationUnit);
		...
		SimpleName fifthY = PMASTQuery
				.simpleNameWithIdentifierInMethodInClassInCompilationUnit("y",
						4, "m", 0, "S", 0, compilationUnit);
