...
public class PMRDefsAnalysisTest extends PMTest {
    ...
    public void testStraightlineCodeUses() {
        ...
        Assignment xAssignment = PMASTQuery.assignmentInMethodInClassInCompilationUnit(0, "m", 0,
                "S", 0, compilationUnit);
    ...
    public void testDefiningInitializer() {
        ...
        VariableDeclaration xDeclaration = PMASTQuery
    ...
    public void testUseInInitializer() {
        ...
        SimpleName firstY = PMASTQuery.simpleNameWithIdentifierInMethodInClassInCompilationUnit(
                "y", 0, "m", 0, "S", 0, compilationUnit);
        ...
        SimpleName secondY = PMASTQuery.simpleNameWithIdentifierInMethodInClassInCompilationUnit(
                "y", 1, "m", 0, "S", 0, compilationUnit);
        ...
        VariableDeclaration yDeclaration = PMASTQuery
    ...
    public void testDefinitionInPostIncrement() {
        ...
        SimpleName thirdY = PMASTQuery.simpleNameWithIdentifierInMethodInClassInCompilationUnit(
                "y", 2, "m", 0, "S", 0, compilationUnit);
        ...
        PostfixExpression yPlusPlus = (PostfixExpression) PMASTQuery
    ...
    public void testDefinitionsInIfThenElseBody() {
        ...
        SimpleName fourthY = PMASTQuery.simpleNameWithIdentifierInMethodInClassInCompilationUnit(
                "y", 3, "m", 0, "S", 0, compilationUnit);
        ...
        Assignment yEquals5 = PMASTQuery.assignmentInMethodInClassInCompilationUnit(0, "m", 0, "S",
                0, compilationUnit);
        Assignment yEquals6 = PMASTQuery.assignmentInMethodInClassInCompilationUnit(1, "m", 0, "S",
                0, compilationUnit);
    ...
    public void testDefinitionsInIfThenBody() {
        ...
        VariableDeclaration yEquals1 = PMASTQuery.localWithNameInMethodInClassInCompilationUnit(
                "y", 0, "m", 0, "S", 0, compilationUnit);
        Assignment yEquals5 = PMASTQuery.assignmentInMethodInClassInCompilationUnit(0, "m", 0, "S",
                0, compilationUnit);
    ...
    public void testDefinitionsInNestedIfThenElse() {
        ...
        SimpleName sixthY = PMASTQuery.simpleNameWithIdentifierInMethodInClassInCompilationUnit(
                "y", 5, "m", 0, "S", 0, compilationUnit);
        ...
        Set<ASTNode> definingNodes = definingNodesFromDefinitions(sixthYUse
                .getReachingDefinitions());

        Assignment yEquals2 = PMASTQuery.assignmentInMethodInClassInCompilationUnit(0, "m", 0, "S",
                0, compilationUnit);
        Assignment yEquals3 = PMASTQuery.assignmentInMethodInClassInCompilationUnit(1, "m", 0, "S",
                0, compilationUnit);
        Assignment yEquals4 = PMASTQuery.assignmentInMethodInClassInCompilationUnit(2, "m", 0, "S",
                0, compilationUnit);
        Assignment yEquals5 = PMASTQuery.assignmentInMethodInClassInCompilationUnit(3, "m", 0, "S",
                0, compilationUnit);
    ...
    public void testDefinitionsInWhileLoop() {
        ...
        Set<ASTNode> fourthYUseDefiningNodes = definingNodesFromDefinitions(fourthYUse
                .getReachingDefinitions());

        VariableDeclaration yEquals1 = PMASTQuery.localWithNameInMethodInClassInCompilationUnit(
                "y", 0, "m", 0, "S", 0, compilationUnit);

        Assignment yEqualsYPlus1 = PMASTQuery.assignmentInMethodInClassInCompilationUnit(0, "m", 0,
                "S", 0, compilationUnit);

        assertTrue(fourthYUseDefiningNodes.contains(yEquals1));
        assertTrue(fourthYUseDefiningNodes.contains(yEqualsYPlus1));

        SimpleName fifthY = PMASTQuery.simpleNameWithIdentifierInMethodInClassInCompilationUnit(
                "y", 4, "m", 0, "S", 0, compilationUnit);
        ...
        Set<ASTNode> fifthYUseDefiningNodes = definingNodesFromDefinitions(fourthYUse
                .getReachingDefinitions());
