...
public class PMNodeReferenceStoreTest {
  ...
  @Test public void testStoreBasics() {
  ...
  @Test public void testNullingOutNodeRemovesReference() {
  ...
  @Test public void testNullingOutReferenceRemovesNode() {
	  PMNodeReferenceStore store = new PMNodeReferenceStore();
  ...
  @Test public void testReplaceNodeWithNodeWithoutExistingReferenceToNewNode() {
	  PMNodeReferenceStore store = new PMNodeReferenceStore();
  ...
  @Test public void testReplaceNodeWithNodeWithExistingReferenceToNewNode() {
	  PMNodeReferenceStore store = new PMNodeReferenceStore();
