...
public class EclipseIssuesTest extends PMTest {
	...
	public void testImpreciseBindingsKeysForDuplicateLocalVariables() {
		...
		/*
		 * System.out.println("firstX binding key is " +
		 * firstX.resolveBinding().getKey());
		 * System.out.println("firstX binding hash is " +
		 * firstX.resolveBinding().hashCode());
		 * 
		 * System.out.println("secondX binding key is " +
		 * secondX.resolveBinding().getKey());
		 * System.out.println("secondX binding hash is " +
		 * secondX.resolveBinding().hashCode());
		 * 
		 * System.out.println("thirdX binding key is " +
		 * thirdX.resolveBinding().getKey());
		 * System.out.println("thirdX binding hash is " +
		 * thirdX.resolveBinding().hashCode());
		 * 
		 * System.out.println("fourthX binding key is " +
		 * fourthX.resolveBinding().getKey());
		 * System.out.println("fourthX binding hash is " +
		 * fourthX.resolveBinding().hashCode());
		 */
		...
		assertEquals(firstX.resolveBinding().getKey(), thirdX.resolveBinding()
				.getKey());
		assertTrue(firstX.resolveBinding().hashCode() != thirdX
				.resolveBinding().hashCode());
	...
	public void testNoBindingsKeysForDuplicateFields() {
		...
		VariableDeclarationFragment firstXField = PMASTQuery
		...
		VariableDeclarationFragment secondXField = PMASTQuery
				.fieldWithNameInClassInCompilationUnit("x", 1, "S", 0,
						compilationUnit);
